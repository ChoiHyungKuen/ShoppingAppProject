...
export const loadMainProducts = createAsyncThunk(
    'main/loadMainProducts',
    async () => {
        try {
            const response = await axios.get('main/getProducts');
...
export const mainSlice = createSlice({
    ...
    extraReducers: {
        ...
        [loadMainProducts.fulfilled]: (state, action) => {
